...
if __name__ == '__main__':
    ...
    parse.add_argument('-c', '--config', type=str, default='./config/standford_cars.yaml')
    ...
    parse.add_argument('--device', type=str, choices=['cuda', 'cpu'], default='cpu')
    parse.add_argument('--cpu_percentage', type=float, default=0.5)
